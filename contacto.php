...
<section class="bg-white dark:bg-gray-600">
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <form action="#" id="contacto-proselein" class="space-y-8">
          ...
          <div class="sm:col-span-2" id="area-mensaje">
          ...
          <div onclick="validarCorreo(event)" id="btn-enviar-mensaje" class="inline-flex items-center py-3 cursor-pointer px-5 text-sm font-medium text-center text-white rounded-lg bg-yellow-400 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Enviar mensaje</div>
      </form>
  </div>
