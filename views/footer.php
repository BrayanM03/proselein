    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://proselein.com/" class="flex items-center">
              <div class="flex-col flex">
                <div class="flex">
                <span class="text-white mr-2 mt-2 text-xl">PROSELEIN</span>
          ...
          <div class="grid grid-cols-3 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Proselein</h2>
            ...
            <!--   <div>
              ...
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="privacidad.php" class="hover:underline">Politica de privacidad</a>
                      </li>
                      <li>
                          <a href="terminos.php" class="hover:underline">Terminos y condiciones</a>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://proselein.com/" class="hover:underline">Proselein™</a>. Todos los derechos reservados.
          </span>
